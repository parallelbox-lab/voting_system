  ...
  Future<void> pickImage(ImageSource source) async {
    ...
    setState(() {
      if (selectedImage != null) {
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: LinearProgressIndicator(
                                          semanticsLabel:
                                              "${(progressPercent * 100).toString()} % تم الرفع...",
                                          minHeight: 10.0,
        ...
        Get.snackbar("خطأ", "لم يتم تحديد أي صورة");
      }
    });
  }
        ...
        child: Column(
          ...
          children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                              ...
                              label: Text("التقط صورة بالكاميرا"))
                        ],
                      ),
                    ),
            ...
            InputField(
              ...
              hintText: 'أسماء المرشحين',
              controller: _candidateNameController,
              obscure: false,
            ),
            InputField(
              prefixIcon: Icons.edit,
              hintText: 'وصف المرشحين',
