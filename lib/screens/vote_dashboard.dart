            ...
            return CustomScrollView(
              slivers: [
                SliverAppBar(
                  ...
                  actions: [
                    IconButton(
                        tooltip: 'نسخ رمز الوصول إلى الانتخابات',
                        icon: Icon(
                          Icons.content_copy,
                          color: Colors.white,
                        ),
                        ...
                        Column(
                          children: [
                            ...
                            ElevatedButton.icon(
                                ...
                                label: Text('أعد إنشاء الكود')),
                          ],
                        ),
                        _StatsBox(Icons.people_alt, 'مرشحين',
                            election["options"].length.toString()),
                        _StatsBox(Icons.how_to_vote, 'مجموع الأصوات',
                                  ...
                                  child: ListView(
                                    children: [
                                      ...
                                      ElevatedButton.icon(
                                          ...
                                          label: Text('احصل على إحصائيات الانتخابات'))
                                    ],
                                  )))
                        ],
                      )
