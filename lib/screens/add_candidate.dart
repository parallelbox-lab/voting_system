            ...
            children: [
              ...
              Padding(
                ...
                child: Padding(
                  ...
                  child: Text(
                      'تصويت ${Get.arguments[1].name.toString().toUpperCase()}',
                      overflow: TextOverflow.ellipsis,
                      style: GoogleFonts.yanoneKaffeesatz(
                          fontSize: 30.0,
                          color: Colors.indigo,
                ...
                return data.length < 1
                    ? SliverToBoxAdapter(
                        child: Column(children: [
                          ...
                          Text('لم تتم إضافة أي مرشح حتى الآن',
                              style: TextStyle(
                                fontSize: 20.0,
                              )),
                          Text(
                            'أضف مرشحين أو خيارات إلى تصويتك لإنهاء العملية',
