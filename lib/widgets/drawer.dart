    ...
    return Container(
      ...
      child: Drawer(
        ...
        child: ListView(padding: EdgeInsets.all(0.0), children: <Widget>[
          ...
          ListTile(
            title: Text('مسكن'),
            subtitle: Text('اذهب إلى الصفحة الرئيسية'),
            leading: _leadingIcon(Icons.home),
            onLongPress: () {},
          ),
          ListTile(
            title: Text('الانتخابات المملوكة'),
            subtitle: Text('انتخاباتي'),
          ...
          ListTile(
            ...
            onTap: () {
              showAboutDialog(
                  ...
                  applicationLegalese: 'حلول التكنولوجيا الشجاعة');
            },
          ),
          ListTile(
